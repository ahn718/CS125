...
public class Colosseum {
    ...
    public static Pokemon buildPokemon() {
        ...
        tempPokemon.setHitPoints(tempInt);
        ...
        tempPokemon.setAttackLevel(tempInt);
        ...
        tempPokemon.setDefenseLevel(tempInt);
